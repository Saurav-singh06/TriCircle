...
export default function Index({ Heading, detail, imgUrl }) {
  return (
    <>
      <div className="stroke-temp bg-temp2 rounded-lg my-7 mx-4 ">
        <div>
        ...
        <div className="pt-6 mx-3 flex justify-between items-center">
          <Button
            className="!bg-black  !text-base  !text-white !px-6  !py-2 "
            variant="outlined"
          >
            Submit
          </Button>
          <a className="!text-base font-semibold px-4 py-4 text-black no-underline" href="/">
            Link
          </a>
        </div>
      </div>
